            ...
            <div class="chat-right">
                <div class="chating">
                    ...
                    <div class="chating-with">
                        <div class="name-chat"><b>티니핑</b></div>
                    </div>
                    <div class="delete-chat" style="color:#D85F5F;">채팅방 삭제하기</div>
                </div>
                ...
                <div class="line-input">
                    <div class="input">
                        <input type="text" v-model="userMessage" @keypress.enter="addMessage"
                            placeholder="Type a message..." />
                    </div>
                    <button class="add btn btn-outline-secondary" @click="addMessage">Send</button>
                </div>
            </div>
        </div>
    </div>
