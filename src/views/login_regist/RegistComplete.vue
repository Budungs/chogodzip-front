<template>
    <div class="container">
      ...
      <!-- 회원가입 완료 화면 -->
      <div class="complete-container text-center">
        ...
        <!-- 버튼들 -->
        <router-link to="/" class="btn-primary">메인 화면으로 가기</router-link>
        <router-link to="/addinfo" class="btn-secondary">추가정보 입력하기</router-link>
      </div>
    </div>
  </template>
